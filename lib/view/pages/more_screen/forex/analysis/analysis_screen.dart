...
import 'package:fx_commission_app/view/pages/more_screen/forex/analysis/analysis_read_article_screen.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SingleChildScrollView(
        child: Column(
          children: [
            containerBelowAppBar(text: 'Analysis'),
