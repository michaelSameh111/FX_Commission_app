...
class _AnalysisAndInsightsScreenState extends State<AnalysisAndInsightsScreen> {
                                ...
                                children: [
                                  ListView.separated(
                                    ...
                                    itemBuilder: (context, index) =>
                                        analysisAndInsightsContainer(
                                            insights: analysisAndInsightsModel
                                                .insights![index]),
                                    itemCount: analysisAndInsightsModel
                                        .insights!.length,
                                    shrinkWrap: true,
                                  ),
                                ],
  ...
  Widget analysisAndInsightsContainer({required Insights insights}) {
    return InkWell(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => InsightsReadArticleScreen(
                      insights: insights,
                    )));
      },
      child: Container(
