                            ...
                            Padding(
                              ...
                              child: Column(
                                children: [
                                        ...
                                        Expanded(
                                          child: ClipRRect(
                                            ...
                                            child: Image.network(
                                                ...
                                                width: double.infinity,
                                                height: 15.h,
                                                '${analysisAndInsightsModel.insights!.image}'),
                                          ),
                                        ),
                                        Expanded(
                                            child: Container(
                                          ...
                                          child: Padding(
                                            ...
                                            child: Column(
                                              ...
                                              children: [
                                                Text(
                                                  '${analysisAndInsightsModel.insights!.title}',
                                                  style: TextStyle(
                                                      fontSize: 18.dp,
                                                      fontWeight:
                                                          FontWeight.bold),
                                                  ...
                                                  children: [
                                                    CircleAvatar(
                                                      ...
                                                      child: ClipOval(
                                                        child: Image.network(
                                                            width: 14.w,
                                                            '${analysisAndInsightsModel.insights!.userImage}'),
                                                      ),
                                                    ),
                                                    SizedBox(width: 2.w),
                                                    Column(
                                                      ...
                                                      children: [
                                                        Text(
                                                          '${analysisAndInsightsModel.insights!.createdBy}',
                                                          style: TextStyle(
                                                            fontSize: 16.dp,
                                                          ),
                                                        ),
                                                        Text(
                                                          '${analysisAndInsightsModel.insights!.createdAt}',
                                                          style: TextStyle(
                                                            color: const Color(
                                                                0xff808080),
                                                            fontSize: 16.dp,
                                  ...
                                  //     insights: analysisAndInsightsModel.insights
                                  //   ),
                                  //   itemCount: 1,
                                  //   shrinkWrap: true,
                                  // ),
